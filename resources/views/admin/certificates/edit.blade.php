<x-admin-master>
    ...
    @section('content')
        ...
        <h1>Создать нового сертификата</h1>
                ...
                <div class="col-lg-6">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Создать нового сертификата</h6>
                        </div>
                        <div class="card-body">
                            <div class="">

                                <img src="{{$certificate->image}}" width="100px" id="replace_img" alt="" >
